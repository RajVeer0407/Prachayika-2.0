...
export default function TopBar() {
  return (
    ...
    >
      ...
      <Link
        to="/"
        className="font-display italic text-[10px] tracking-luxury uppercase text-gold/60
      ...
      <div className="flex items-center gap-6 ml-auto">
        ...
        <a
          ...
          className="flex items-center gap-2 font-display text-[10px] tracking-wide
                     text-cream/60 hover:text-gold transition-colors duration-300"
        >
        ...
        <a
          href={`mailto:${EMAIL}`}
          className="hidden md:flex items-center gap-2 font-display text-[10px] tracking-wide
                     text-cream/60 hover:text-gold transition-colors duration-300"
        >
          {/* Mail icon */}
          <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
